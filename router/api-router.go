...
func SetApiRouter(router *gin.Engine) {
	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		logRoute.GET("/token_names", middleware.AdminAuth(), middleware.SearchRateLimit(), controller.GetLogTokenNames)
		logRoute.GET("/self/stat", middleware.UserAuth(), controller.GetLogsSelfStat)
		logRoute.GET("/self/token_names", middleware.UserAuth(), middleware.SearchRateLimit(), controller.GetUserLogTokenNames)
